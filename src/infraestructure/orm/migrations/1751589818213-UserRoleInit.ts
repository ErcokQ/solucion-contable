...
export class UserRoleInit1751589818213 implements MigrationInterface {
  name = 'UserRoleInit1751589818213';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`email\` varchar(120) NOT NULL, \`passwordHash\` varchar(60) NOT NULL, \`fullName\` varchar(120) NOT NULL, \`username\` varchar(60) NOT NULL, \`provider\` varchar(30) NOT NULL DEFAULT 'local', \`avatar\` varchar(255) NULL, \`activo\` tinyint NOT NULL DEFAULT 1, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), UNIQUE INDEX \`IDX_fe0bb3f6520ee0469504521e71\` (\`username\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
